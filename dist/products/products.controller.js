...
let ProductsController = class ProductsController {
    ...
    async addProduct(prodName, prodQuant, prodPrice) {
        const generatedId = await this.productsService.insertProduct(prodName, prodQuant, prodPrice);
    ...
    async updateProduct(prodId, prodName, prodQuant, prodPrice) {
