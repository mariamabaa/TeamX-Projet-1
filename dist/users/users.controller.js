...
let UsersController = class UsersController {
    ...
    async addUser(userfirstname, userLast, useraddress) {
        const generatedId = await this.usersService.insertUser(userfirstname, userLast, useraddress);
    ...
    async updateUser(userId, userfirstname, userLast, useraddress) {
